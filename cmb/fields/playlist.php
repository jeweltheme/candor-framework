...
wp_localize_script( 'pixplaylist', 'playlist_locals', array(
	...
	'pixtypes_l18n' => array(
		'confirmClearGallery' => __( 'You want for sure to clear this gallery?', 'candor' ),
		'alertGalleryIsEmpty' => __( 'Gallery is already empty!', 'candor' )
	)
) ); ?>
<div id="pixvideos" class="hidden">
	...
	<a class="open_pixvideos" href="#">
		...
		<div><i class="icon dashicons dashicons-format-video"></i> <span><?php _e('Add Video', 'candor' ); ?></span></div>
		<span class="clear_gallery"><?php _e( 'Clear', 'candor' ); ?></span>
	</a>
</div>