...
function candor_vc_content_video_block_shortcode_vc() {
	...
	vc_map( 
		array(
			...
			"name" => esc_html__("Left Video, Right Content", 'cast'),
			"base" => "elevation_content_video_box",
			"category" => esc_html__('Elevation WP Theme', 'cast'),
			"params" => array(
				array(
					'type' 			=> 'textfield',
					'heading' 		=> esc_html__( 'Video URL', 'cast' ),
					'param_name' 	=> 'video_url',
					'value' 		=> 'http://player.vimeo.com/video/85517984',
					"admin_label" 	=> true,
					'description' 	=> esc_html__( 'Enter the URL of Youtube/Vimeo Video', 'cast' )
					),

				array(
					"type" 			=> "textfield",
					"heading" 		=> esc_html__("Title", 'cast'),
					"param_name" 	=> "title",
					'holder' 		=> 'div',
				...
				array(
					"type" 			=> "textarea_html",
					"heading" 		=> esc_html__("Block Content", 'cast'),
					"param_name" 	=> "content",
					'holder' 		=> 'div',
				...
				array(
			    	"type" 			=> "textfield",
			    	"heading" 		=> esc_html__("Learn More Button", 'cast'),
			    ...
			    array(
			    	"type" 			=> "textfield",
			    	'heading'      	=> esc_html__( 'Learn More Button URL', 'cast' ),
			    ...
			    array(
			    	"type" 			=> "textfield",
			    	"heading" 		=> esc_html__("Donate Button", 'cast'),
			    ...
			    array(
			    	"type" 			=> "textfield",
			    	'heading'      	=> esc_html__( 'Donate Button URL', 'cast' ),
