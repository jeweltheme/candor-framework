 ...
 * The Shortcode
 */
function candor_framework_videostories_most_liked_shortcode( $atts ) {
	extract( 
		shortcode_atts( 
			array(
				'title'			=> 'Most Liked',
  ...
  <section class="video-contents">
  	<div class="section-padding">
  		...
  		<h2 class="section-title"><?php echo esc_attr( $title );?></h2><!-- /.section-title -->
		    ...
		    <div class="most-liked owl-carousel">
...
add_shortcode( 'videostories_most_liked', 'candor_framework_videostories_most_liked_shortcode' );


/**
 * The VC Functions
 */
function candor_framework_videostories_most_liked_shortcode_vc() {
	
	vc_map( 
		array(
			"icon" => 'videstories-vc-block',
			"name" => esc_html__("Section: Most Liked", 'videstories'),
			"base" => "videostories_most_liked",
			"category" => esc_html__('VideoStories WP Theme', 'videstories'),
			'description' => 'Show Most Liked.',
			"params" => array(
				array(
					"type" => "textfield",
...
add_action( 'vc_before_init', 'candor_framework_videostories_most_liked_shortcode_vc');