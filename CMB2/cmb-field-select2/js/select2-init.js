(function( $ ) {
	...
	$( '.cmb-type-candor_pw_select .select2' ).each(function() {
		$( this ).select2({
			allowClear: true
		});
	});

	$( '.cmb-type-candor_pw_multiselect .select2, .cmb-type-candor_pw_multiselect_cpt .select2' ).each(function() {
		var instance = $( this ),
		...
		$( instance ).select2({
			...
			initSelection: function( element, callback ) {
				...
				$( element.val().split( ',' ) ).each(function() {
					var text = candor_pw_select2_find_text( this, instance_data );
	...
	function candor_pw_select2_find_text( id, instance_data ) {
		var i, l;
